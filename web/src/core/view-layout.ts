...
export const PLAYER_STRIDE = 10;
export const P = { X: 0, Y: 1, HP: 2, LIFE: 3, FACING: 4, WEAPON: 5, HURT: 6, DOWN_TIMER: 7, REVIVE: 8, KILLS: 9 } as const;
...
export const EventKind = { Hit: 1, Kill: 2, PlayerHurt: 3, Down: 4, Revive: 5, Unlock: 6, WaveStart: 7, GameOver: 8, Fire: 9 } as const;
...
export const WEAPON_NAMES = ['권총', '기관단총', '샷건'] as const;
